...
- Generated text is English-only and separated into Association Image Cue plus one final Mnemonic. Mnemonic uses a strong hook only when it passes hook judging; otherwise it is story-only.
